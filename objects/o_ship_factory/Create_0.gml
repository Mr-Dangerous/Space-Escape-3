...
secondary_attack_exists = false
secondary_attack_number = 0 //quantity of attacks per attack
secondary_attack_projectile_speed = 0
secondary_attack_projectile_duration = 0
secondary_attack_weapon_speed = 0 // divide by 60 for attacks per second
secondary_attack_weapon_damage = 0 
secondary_attack_weapon_mass = 0
energy_starting = 0
energy_to_cast = 0 //
